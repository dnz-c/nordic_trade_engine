...
void itch_parser::run_parser(const wchar_t* path)
{
    HANDLE file = NULL;
    ...
    do
    {
        file = CreateFile(path, GENERIC_READ, NULL, NULL, OPEN_ALWAYS, FILE_ATTRIBUTE_NORMAL, NULL);
        if (!file)
        {
